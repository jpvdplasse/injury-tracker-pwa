  ...
  return (
    <div className="h-full flex flex-col px-4 pt-3 pb-2">
      <div className="text-center mb-2">
        <h1 className="text-lg font-bold text-white">Blessure Logboek</h1>
        <p className="text-xs text-gray-500">Tik op een lichaamsdeel om een blessure te registreren</p>
      </div>
